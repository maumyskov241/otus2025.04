        ...
        <div class="row g-3">
          <div class="col-12">
            <Field name="fio" rules="required|min:4|max:255" v-slot="{ field, meta }">
              ...
              <input v-bind="field" id="fio" class="form-control" type="text" v-model.trim="fio" placeholder="ФИО"
          ...
          <div class="col-12">
            <Field name="mail" rules="required|email|max:255" v-slot="{ field, meta }">
              ...
              <input v-bind="field" id="mail" class="form-control" type="text" v-model.trim="mail" placeholder="Почта"
                :class="meta.touched ? (meta.valid ? 'valid' : 'invalid') : ''" />
            </Field>
          ...
          <div class="col-sm-6">
            <Field name="birthday" rules="required" v-slot="{ field, meta }">
              ...
              <input v-bind="field" id="birthday" class="form-control" type="date" v-model.trim="birthday"
                placeholder="Дата рождения" :class="meta.touched ? (meta.valid ? 'valid' : 'invalid') : ''" />
            </Field>
          ...
          <div class="col-12">
            <Field name="adress" :rules="{ required: true, min: 20 }" v-slot="{ field, meta }">
              <label for="adress" class="form-label">Адрес <b> осталось {{ 200 - adress.length }} символов</b></label>
              <textarea v-bind="field" id="adress" class="form-control" v-model.trim="adress" placeholder="Адрес"
                maxlength="200" :class="meta.touched ? (meta.valid ? 'valid' : 'invalid') : ''" />
            </Field>
            ...
            <div style="height:70px">
              ...
              <Field name="card.main" rules="required|integer|min:16|max:16" v-slot="{ field, meta }">
                <div style="width: 220px; float: left; margin-right:10px;">
                  ...
                  <input v-bind="field" id="card.main" class="form-control" type="text" v-model.trim="card.main"
              ...
              <Field name="card.second" rules="required|integer|min:3|max:3" v-slot="{ field, meta }">
                <div style="width: 80px; float: left; ">
                  ...
                  <input v-bind="field" id="card.second" class="form-control" type="password" v-model.trim="card.second"
                    maxlength="3" placeholder="***" :class="meta.touched ? (meta.valid ? 'valid' : 'invalid') : ''" />
                </div>
              </Field>
            </div>
            <div v-if="errors['card.main'] !== undefined || errors['card.second'] !== undefined" role="alert">Необходимо
          ...
          <div data-v-2d88a157="" class="col-sm-offset-2 col-sm-12 d-flex align-items-center justify-content-center">
